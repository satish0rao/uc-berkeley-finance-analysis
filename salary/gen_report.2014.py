...
a2015 = pd.read_csv("data/2013_UniversityOfCalifornia.csv")
...
public_service = basic_report_pay(a2015,title_name='Museum',match_list=['museum'],exclude_list=[])
public_service += basic_report_pay(a2015,title_name='Curator',match_list=['curator'],exclude_list=[])
...
print "Total overhead to .544: ", total-(good_stuff) - ((good_stuff)*.544/.456)
